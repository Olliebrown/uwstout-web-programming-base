/**
 * Based on cm6-themes-basic-dark
 * https://github.com/craftzdog/cm6-themes/tree/main/packages/basic-dark
...
const selection = '#384936' // Made significantly brighter by Olliebrown
const cursor = base01
...
export const basicDarkTheme = EditorView.theme(
  {
    ...
    '&.cm-focused .cm-selectionBackground, .cm-selectionBackground, .cm-content ::selection':
      { backgroundColor: selection + '!important' }, // Important added by Olliebrown
